...
public class CatalogExposureSender {
    /**
     * How many ExposureInfos to send in on part. Too much sent at once can exceed packed size limits.
     */
    public static final int PART_SIZE = 2500;

    public static void sendExposuresListToPlayer(List<ExposureInfo> exposures, ServerPlayer player) {
        List<List<ExposureInfo>> parts = Lists.partition(exposures, PART_SIZE);
