...
import io.github.mortuusars.exposure_catalogue.forge.event.ClientEvents;
import io.github.mortuusars.exposure_catalogue.forge.event.CommonEvents;
...
@Mod(ExposureCatalogue.ID)
public class ExposureCatalogueForge {
    public ExposureCatalogueForge() {
